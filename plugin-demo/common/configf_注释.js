...
var ChannelIdjy=1200004;  // 渠道号类似于我们的原来的网盟的 6501， 8000 ，9000之内的
var Config = {
    cpshost: "http://www.98fanli.com",   // 导购返利站的中转跳转的地址，类似于金山导购站
    searchhost: "http://www.tfss123.com", //  我们自已的导航站，类似于www.hao123.com
    haulBackhost:"http://www.tfdhbf123.com", //类似于我们fiiquu.com之类的导购站
    protecthost: "http://www.tfdhbf123.com", //类似于我们fiiquu.com之类的导购站
    tmallhost: "http://www.tfdhbf123.com",  //类似于我们fiiquu.com之类的导购站
    channel: 1200004,   //渠道号
    Bundles: {  // 分类
        cps: {  //返利站 a-a的跳转 --->1
            "banggo.com": {  //网站域名
               transit: "/c/"+ ChannelIdjy +"/banggo",  //跳转的链结  
               matchs: [   // 匹配字段 
        ...
        cpsUrl:{  //返利站的url，具体的返利的url  字段为，网名关键字和 具体的我们自已的url链结 
        ...
        tmall: {  //天猫返利站
           "tmall.com": {
            ...
            "www.taobao.com":{ //淘宝站
                ...
                precise : "%u6DD8%u5B9D%u7F51-%u6DD8%21%u6211%u559C%u6B22",  //淘宝网-淘!我喜欢
            },
            "ai.taobao.com":{ //爱淘宝站
                chance: "100%",  //优先级
                hostUrl : "http://ai.taobao.com?pid=mm_96301239_9120154_30522442"  //我们的返利的url，当前的通道
            }, 
            "ju.taobao.com":{  //聚淘宝
                chance: "100%",
